...
function renderResults () {
  if (score >= 8) {
    $('.questionAnswerForm').html(`<div class="results correctFeedback"><h3>You are a Harverd Graduate</h3><img src="" alt="lil pump graduate"/><p>You got ${score} / 10</p><p>Go show the world your high IQ</p><button class="restartButton">Restart Quiz</button></div>`);
  } else if (score < 8 && score >= 5) {
    $('.questionAnswerForm').html(`<div class="results correctFeedback"><h3>You're a lil pump fan</h3><img src="" alt="lil pump fan"/><p>You got ${score} / 10</p><p>Join Harverd University to be as smart as Lil Pump</p><button class="restartButton">Restart Quiz</button></div>`);
  } else {
    $('.questionAnswerForm').html(`<div class="results correctFeedback"><h3>Lil Pump does not care about you!</h3><img src="" alt="pump laughing"/><p>You got ${score} / 10</p><p>You seems like a Icy Narco fan</p><button class="restartButton">Restart Quiz</button></div>`);
  }
}
