...
function renderResults () {
  if (score >= 8) {
    ...
    $('.questionAnswerForm').html(`<div class="results correctFeedback"><h3>Lil Pump does not care about you!</h3><img src="https://media.giphy.com/media/3o6MbiyEJnfz9guzu0/giphy.gif" alt="pump laughing"/><p>You got ${score} / 10</p><p>You seem like an Icy Narco fan</p><button class="restartButton">Restart Quiz</button></div>`);
  }
}
